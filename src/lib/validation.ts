...
// Combined Qualification and Contact Schema for Step 2
export const qualificationWithContactSchema = z.object({
  full_name: z
    .string()
    .min(2, 'Name must be at least 2 characters')
    .max(255, 'Name is too long')
...
export type QualificationWithContactFormData = z.infer<typeof qualificationWithContactSchema>;
